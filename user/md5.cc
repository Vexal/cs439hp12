...
void MD5::update(const unsigned char input[], size_type length)
{
  ...
  if (length >= firstpart)
  {
    ...
    copy(&buffer[index], input, firstpart);
    transform(buffer);
  ...
  copy(&buffer[index], &input[i], length-i);
}
...
// sprintf source: http://www.dreamincode.net/forums/topic/287607-diy-sprintf/
